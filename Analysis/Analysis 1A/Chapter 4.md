...
**Solution.** If we suspect convergence, then we have to identify a limit. Inspection of the sequence suggests the limit $0$ . Now to check if indeed $\underset{n \to \infty}{ \lim } 1 / n = 0$ , we need to verify the criterion. This is what we do next.
...
This proves that $\underset{n \to \infty}{ \lim } a^{n} = 0$ . □

### Proposition 3.

Suppose that $((a_{n} ))_{n \in \N}$ and $((b_{n} ))_{n \in \N}$ are real sequences with $a_{n} \leq b_{n}$ for all $n \in \N$ . If $L = \underset{n \to \infty}{ \lim } a_{n}$ and $M = \underset{n \to \infty}{ \lim } b_{n}$ exist, then $L \leq M$ .

#### Proof

We argue by contradiction.

Suppose (seeking contradiction) that $M < L$ . Let $\epsi = (L - M ) / 2$ . Since $a_{n} \to L$ as $n \to \infty$ , there exists $N_{1} \in \N$ such that $|a_{n} - L| < \epsi$ for all $n \geq N_{1}$ . Similarly, there exists $N_{2} \in \N$ such that $|b_{n} - M| < \epsi$ for all $n \geq N_{2}$ . Now set $N =  \max  \{ N_{1} , N_{2} \}$ . Then for all $n \geq N$ ,
...
1.  If $b \in \R$ is a number with $a_{n} \leq b$ for all $n \in \N$ , then $\underset{n \to \infty}{ \lim } a_{n} \leq b$ .
2.  If $c \in \R$ is a number with $a_{n} \geq c$ for all $n \in \N$ , then $\underset{n \to \infty}{ \lim } a_{n} \geq c$ .
...
Suppose that $((a_{n} ))_{n \in \N}$ converges and let $L = \underset{n \to \infty}{ \lim } a_{n}$ . Apply the convergence criterion with $\epsi = 1$ . This yields a number $N \in \N$ such that $|a_{n} - L| < 1$ for all $n \geq N$ . Hence
...
Let $((a_{n} ))_{n \in \N}$ and $((b_{n} ))_{n \in \N}$ be convergent sequences with limits $A = \underset{n \to \infty}{ \lim } a_{n}$ and $B = \underset{n \to \infty}{ \lim } b_{n}$ . Then

1.  $\underset{n \to \infty}{ \lim } (a_{n} + b_{n} ) = A + B$ ,
2.  $\underset{n \to \infty}{ \lim } (a_{n} - b_{n} ) = A - B$ ,
3.  $\underset{n \to \infty}{ \lim } C a_{n} = C A$ for any constant $C \in \R$ ,
4.  $\underset{n \to \infty}{ \lim } (a_{n} b_{n} ) = A B$ , and
5.  if $b_{n} \neq 0$ for all $n \in \N$ and if $B \neq 0$ , then $\underset{n \to \infty}{ \lim } (a_{n} / b_{n} ) = A / B$ .
...
(Here we have used the triangle inequality.) Hence $a_{n} + b_{n} \to A + B$ as $n \to \infty$ .
...
(iii) Consider the sequence $((c_{n} ))_{n \in \N}$ with $c_{n} = C$ for every $n \in \N$ . Then $\underset{n \to \infty}{ \lim } c_{n} = C$ by Proposition 36. Now we simply apply (iv), which gives

$$
\underset{n \to \infty}{ \lim } (C a_{n} ) = \underset{n \to \infty}{ \lim } (c_{n} a_{n} ) = C A .
$$
...
By (iii), we have the limit $\underset{n \to \infty}{ \lim } ((- 1 ) b_{n} ) = - B$ . Now (i) implies that

$$
\underset{n \to \infty}{ \lim } (a_{n} - b_{n} ) = A + (- B ) = A - B .
$$

(v) Here we first prove that

$$
\underset{n \to \infty}{ \lim }\frac{1}{b_{n}}=\frac{1}{B}.
$$
...
$$
\underset{n \to \infty}{ \lim } \frac{a_{n}}{b_{n}} = \underset{n \to \infty}{ \lim } (a_{n} \frac{1}{b_{n}}) = \frac{A}{B} .
$$
...
$$
\underset{n \to \infty}{ \lim } \frac{2^{- n} + n^{3} - 7 n}{5 n^{3} + 2 n^{2} - 8 n + 9} .
$$
...
$$
\frac{((1 / 2 ))^{n}}{n^{3}} = ((\frac{1}{2}))^{n} (\frac{1}{n}) (\frac{1}{n}) (\frac{1}{n}) \to 0 \cdot 0 \cdot 0 \cdot 0 = 0 \text{as  }N\to\infty
$$

by Theorem 42. Similarly,

$$
\frac{7}{n^{2}} \to 0 , \frac{2}{n} \to 0 , \frac{8}{n^{2}} \to 0 , \frac{9}{n^{3}} \to 0 \text{as  }N\to\infty .
$$

Using Theorem 42 again, we finally find that

$$
\underset{n \to \infty}{ \lim } \frac{2^{- n} + n^{3} - 7 n}{5 n^{3} + 2 n^{2} - 8 n + 9} = \frac{0 + 1 - 0}{5 + 0 - 0 + 0} = \frac{1}{5} .
$$
...
1.  If $a_{n} \to L$ as $n \to \infty$ for some $L \in \R$ , then $|a_{n}| \to |L|$ as $n \to \infty$ .
2.  If $|a_{n}| \to 0$ as $n \to \infty$ , then $a_{n} \to 0$ as $n \to \infty$ as well.

But caution: the second statement becomes false if $0$ is replaced by any other value. For example, consider the sequence with $a_{n} = ((- 1 ))^{n}$ . Then $|a_{n}| = 1 \to 1$ as $n \to \infty$ , but $((a_{n} ))_{n \in \N}$ oscillates between $- 1$ and $1$ and does not converge.

#### Proof

(i) Suppose that $a_{n} \to L$ as $n \to \infty$ . Given $\epsi > 0$ , choose $N \in \N$ such that $|a_{n} - L| < \epsi$ for all $n \geq N$ . Then by the reverse triangle inequality,
...
1.  We say that a real sequence $((a_{n} ))_{n \in \N}$ **diverges to $\infty$** if for all $M \in \R$ there exists $N \in \N$ such that $a_{n} > M$ for all $n \geq \N$ . In this case, we write $a_{n} \to \infty$ as $n \to \infty$ or $\underset{n \to \infty}{ \lim } a_{n} = \infty$ .
2.  We say that $((a_{n} ))_{n \in \N}$ **diverges to $- \infty$** if for all $M \in \R$ there exists $N \in \N$ such that $a_{n} < M$ for all $n \in \N$ . In this case, we write $a_{n} \to - \infty$ as $n \to \infty$ or $\underset{n \to \infty}{ \lim } a_{n} = - \infty$ .
...
exists. We claim that $L = \underset{n \to \infty}{ \lim } a_{n}$ .
...
### Theorem 4 implies that $x = \underset{n \to \infty}{ \lim } a_{n}$ exists. As we have seen that $a_{n} > 1$ for all $n \in \N$ , the limit will satisfy $x \geq 1$ . By the algebra of limits theorem (Theorem 42), it also satisfies

$$
x = \underset{n \to \infty}{ \lim } a_{n + 1} = \underset{n \to \infty}{ \lim } (\frac{a_{n}}{2} + \frac{1}{a_{n}}) = \frac{x}{2} + \frac{1}{x} .
$$
...
$$
\underset{n \to \infty}{ \lim } a_{n} = \underset{n \to \infty}{ \lim } c_{n} ,
$$

then $((b_{n} ))_{n \in \N}$ converges as well and

$$
\underset{n \to \infty}{ \lim } a_{n} = \underset{n \to \infty}{ \lim } b_{n} = \underset{n \to \infty}{ \lim } c_{n} .
$$

#### Proof

Assume that $((a_{n} ))_{n \in \N}$ and $((c_{n} ))_{n \in \N}$ do indeed converge with $a_{n} \to L$ and $c_{n} \to L$ as $n \to \infty$ for some $L \in \R$ . We need to show that $b_{n} \to L$ as well as $n \to \infty$ .
...
This permits an application of Theorem 50 with $a_{n} = - 1 / n$ and $c_{n} = 1 / n$ for $n \in \N$ . Then $a_{n} \leq b_{n} \leq c_{n}$ , because $|\sin n| \leq 1$ , for all $n \in \N$ . Since $\underset{n \to \infty}{ \lim } (- 1 / n ) = \underset{n \to \infty}{ \lim } (1 / n ) = 0$ , it follows that

$$
\underset{n \to \infty}{ \lim } \frac{\sin n}{n} = 0.
$$
...
If $((a_{n} ))_{n \in \N}$ is a real sequence such that $\underset{n \to \infty}{ \lim } a_{n} = 0$ and $a_{n} \neq 0$ for all $n \in \N$ , then $((1 / a_{n} ))_{n \in \N}$ is divergent.

#### Proof

We first prove that $1 / |a_{n}| \to \infty$ as $n \to \infty$ . To this end, let $M > 0$ . Set $\epsi = 1 / M$ and choose $N \in \N$ such that $|a_{n}| < \epsi$ for all $n \geq N$ . Then $1 / |a_{n}| > 1 / \epsi = M$ for all $n \geq N$ . So indeed, we have shown that $1 / |a_{n}| \to \infty$ as $n \to \infty$ .
...
1.  If $0 \leq r < 1$ , then $a_{n} \to 0$ as $n \to \infty$ .
2.  If $r > 1$ , then $a_{n} \to \infty$ as $n \to \infty$ .
...
$$
\frac{1 / a_{n + 1}}{1 / a_{n}} = \frac{1}{\frac{a_{n + 1}}{a_{n}}} \to \frac{1}{r} < 1
$$

as $n \to \infty$ by Theorem 42. If $r = \infty$ , then

$$
\frac{1 / a_{n + 1}}{1 / a_{n}} \to 0
$$

as $n \to \infty$ . (That’s because for any $\epsi > 0$ there exists $N \in \N$ such that $a_{n + 1} / a_{n} > 1 / \epsi$ for all $n \geq N$ , and then

$$
\frac{1 / a_{n + 1}}{1 / a_{n}} = \frac{1}{a_{n + 1} / a_{n}} < \epsi
$$

for $n \geq N$ .) In either case, we conclude that $((1 / a_{n} ))_{n \to \infty}$ converges to $0$ . Then $a_{n} \to \infty$ as $n \to \infty$ , as shown in an exercise. □
...
$$
\frac{a_{n + 1}}{a_{n}} = \frac{2^{n} (n + 1 )}{2^{n + 1} n} = \frac{1}{2} (1 + \frac{1}{n}) \to \frac{1}{2}
$$

as $n \to \infty$ . Hence the growth factor test says that $a_{n} \to 0$ as $n \to \infty$ .
...
$$
\frac{n^{k}}{a^{n}} \to 0 \text{and } \frac{a^{n}}{n^{k}} \to \infty
$$

as $n \to \infty$ .

Roughly speaking, this result says that exponential growth (as in $a^{n}$ ) beats polynomial growth (as in $n^{k}$ ) as $n \to \infty$ .
...
$$
\frac{\frac{((n + 1 ))^{k}}{a^{n + 1}}}{\frac{n^{k}}{a^{n}}} = \frac{1}{a} ((1 + \frac{1}{n}))^{k} \to \frac{1}{a}
$$

as $n \to \infty$ . This proves the convergence of the first sequence, and if we take the reciprocal value, it also proves the divergence of the second sequence. □
...
for all $k \geq K$ , and we conclude that $a_{n_{k}} \to L$ as $k \to \infty$ . □
...
By Theorem 63, there exists a convergent subsequence $((a_{n_{k}} ))_{k \in \N}$ . Let $L = \underset{k \to \infty}{ \lim } a_{n_{k}}$ . We claim that $a_{n} \to L$ as $n \to \infty$ as well.
...
Hence we have proved that $a_{n} \to L$ as $n \to \infty$ . □
...
1.  If it is bounded above, then we define
    ...
    $$
    (\lim \sup)_{n \to \infty} a_{n} = \underset{k \to \infty}{ \lim } \underset{n \geq k}{\sup} a_{n} .
    $$

    Otherwise, $(\lim \sup)_{n \to \infty} a_{n} = \infty$ .

2.  If $((a_{n} ))_{n \in \N}$ is bounded below, then we define

    $$
    (\lim \inf)_{n \to \infty} a_{n} = \underset{k \to \infty}{ \lim } \underset{n \geq k}{\inf} a_{n} .
    $$

    Otherwise, $(\lim \inf)_{n \to \infty} a_{n} = - \infty$ .
...
$$
(\lim \inf)_{n \to \infty} a_{n} = (\lim \inf)_{n \to \infty} a_{n} = \infty .
$$
...
$$
(\lim \sup)_{n \to \infty} a_{n} = 1 \text{and } (\lim \inf)_{n \to \infty} a_{n} = - 1.
$$
...
$$
(\lim \inf)_{n \to \infty} a_{n} \leq (\lim \sup)_{n \to \infty} a_{n} .
$$
...
$$
(\lim \sup)_{n \to \infty} a_{n} = (\lim \inf)_{n \to \infty} a_{n}
$$

and the common value is a real number (not $\infty$ or $- \infty$ ). If so, then

$$
\underset{n \to \infty}{ \lim } a_{n} = (\lim \sup)_{n \to \infty} a_{n} = (\lim \inf)_{n \to \infty} a_{n} .
$$

#### Proof

Suppose that $((a_{n} ))_{n \in \N}$ converges. Let $L = \underset{n \to \infty}{ \lim } a_{n}$ . Then for any $\epsi > 0$ , we may choose $N \in \N$ such that
...
$$
L - \epsi \leq (\lim \inf)_{n \to \infty} a_{n} \leq (\lim \sup)_{n \to \infty} a_{n} \leq L + \epsi .
$$

But this is true for any $\epsi > 0$ , so

$$
L \leq (\lim \inf)_{n \to \infty} a_{n} \leq (\lim \sup)_{n \to \infty} a_{n} \leq L .
$$

That is,

$$
L = (\lim \inf)_{n \to \infty} a_{n} = (\lim \sup)_{n \to \infty} a_{n} .
$$

Now suppose that

$$
(\lim \inf)_{n \to \infty} a_{n} = (\lim \sup)_{n \to \infty} a_{n}
$$
...
for all $k \geq N$ . This proves that $L = \underset{n \to \infty}{ \lim } a_{n}$ . □
