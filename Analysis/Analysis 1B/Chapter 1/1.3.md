...
Let $f: D\to \R$ with $D\subset \R$ and let $c \in D$. Then, $f$ is called _continuous at $c$_ if for any $\varepsilon > 0$ there exists $\delta > 0$ such that
...
Thus $f$ is continuous at $c$. As $c\in (0,1)$ was arbitrary, $f: (0,1)\to \R$ is continuous.
...
$$
\begin{align} |f(x_\delta )-f(c)| \geq \varepsilon . \end{align}
$$
...
$$
\begin{align} \forall y \in E, \quad |y-g(c)|<\eta \quad \Longrightarrow \quad |f(y)-f(g(c))|<\varepsilon . \end{align}
$$
