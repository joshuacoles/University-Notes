...
Let $a<b$, $f : (a,b)\to \R$, and let $c \in (a,b)$. We say that $f$ is differentiable at $c$ if
...
Let $a<b$ and $f: (a,b) \to \R$. We say that _$f$ is differentiable on $(a,b)$_ if $f$ is differentiable at $c$ for all $c \in (a,b)$,
...
$$
\begin{align} \left |x-c\right | < \delta \quad \Longrightarrow \quad \left |f(x)-\left [f(c)+a(x-c)\right ]\right | \leq \varepsilon \left |x-c\right |. \end{align}
$$
