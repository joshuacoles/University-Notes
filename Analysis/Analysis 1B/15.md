...
*   Proof.
    ...
    $$ \begin{align} \label {11b} |f(x_\delta )-f(c)| \geq \varepsilon . \end{align} $$ We consider $\delta _n=1/n$, for $n\in \N$. Then
...
*   Proof.
    ...
    $$ \begin{align} \label {cont-f} \forall y \in E, \quad |y-g(c)|<\eta \quad \Longrightarrow \quad |f(y)-f(g(c))|<\varepsilon . \end{align} $$ As $g$ is continuous at $c$, we may apply Deﬁnition 1.18 and ﬁnd $\delta > 0$ such that
