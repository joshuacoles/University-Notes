...
## Theorem 17 (Sequential characterisation of the limit).
...
## Theorem 17 shows that statement (b) may be used as an alternative definition to Definition 1.3. The sequential characterisation of the limit allows us to extend several results on limits of sequences to limits of functions.
