...
Let us show that indeed $\displaystyle \inf _{x_1\in I} \delta (x_1) = 0$ can happen. Consider $f \colon (0,1) \to \R$, $f(x) = \frac {1}{x}$. Let $\varepsilon >0$ be given and let us try to find $\delta (x_1)>0$ with the property
