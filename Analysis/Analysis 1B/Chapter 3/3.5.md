...
Let $a< b$ and $f : [a,b]\to \R$ be a bounded function. For any $a<c<b$, $f$ is integrable in $[a,b]$ if and only $f$ is integrable in $[a,c]$ and $f$ is integrable in $[c,b]$. In this case we have
...
Let $A, B \in \R$ with $A < B$ and $f: [A,B]\to \R$ be integrable. For any $a,b\in [A,B]$, $a\leq b$ we define
...
$$
\begin{align} \int _a^b f = \int _a^c f + \int _c^b f . \end{align}
$$

## Theorem 3.25 (Linearity of the integral).

Let $f,g: [a,b]\to \R$ be integrable and $\alpha \in \R$.
...
$$
\begin{align} \int _a^b (f+g) = \int _a^b f + \int _a^b g . \end{align}
$$
...
Let $f,g: [a,b]\to \R$ be integrable functions. Then $f\cdot g$ is integrable in $[a,b]$.

## Theorem 3.27

Let $f,g: [a,b]\to \R$ be integrable, such that $f(x)\leq g(x)$ for all $x\in [a,b]$. Then
...
Let $f: [a,b]\to \R$ be integrable. Then $|f|$ is integrable in $[a,b]$ and

%%\seteqnumber{0}{3.}{15}%%

$$
\begin{align} \Bigl |\int _a^b f \Bigr |\leq \int _a^b |f| . \end{align}
$$
...
$$
\begin{align} U(f+g,P) & \leq U(f,P) + U(g,P) \\ L(f+g,P) & \geq L(f,P) + L(g,P) . \end{align}
$$
...
$$
\begin{align} \sup _{I_i}(f+g) \leq \sup _{I_i}f + \sup _{I_i} g . \end{align}
$$
...
$$
\begin{align} U(f,P) - L(f,P) < \frac {\varepsilon }{2} , \quad U(g,P) - L(g,P) < \frac {\varepsilon }{2}. \end{align}
$$
...
$$
\begin{align} U(f+g,P)-L(f+g,P) \leq U(f,P) - L(f,P) + U(g,P)- L(g,P) < \varepsilon . \end{align}
$$
...
$$
\begin{align} \sup _{I_j} |f| - \inf _{I_j} |f| \leq \sup _{I_j} f - \inf _{I_j} f. \end{align}
$$
...
$$
\begin{align} |f(x)|- |f(y)|\leq |f(x)-f(y)| = f(x) - f(y) \leq \sup _{I_j} f - \inf _{I_j} f. \end{align}
$$
