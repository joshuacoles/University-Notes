...
where $n\unit{m^{-3}}$ is the density of charges and $q\unit{C}$ their strength.
...
Electrons within the conductor experience an external force, namely the [[Lorentz Force]] $\vF = e\E$ due the the externally applied [[Electric Field]]. Taking the [[042. Lec 12, Electrons in solids, Drude model#Equation of Motion]]
