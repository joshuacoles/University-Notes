...
Computing an equation of motion for this system, under an imposed electric field $\E$ we have the following. Firstly this leads to an imposed [[Lorentz Force|force]] of $\vF = -e \E$ and a consequential work done, under a small displacement $\delta \vx$ given by
