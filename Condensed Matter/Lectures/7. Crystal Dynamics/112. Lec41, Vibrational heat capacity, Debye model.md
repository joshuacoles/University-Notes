...
Whereas the [[Einstein Model of Vibrational Heat Capacity]] assumes that all oscillations are independent and thus that they sum linearly, the [[Debye model of Vibrational Heat Capacity]] goes one step further dealing with

are oscillating independently of each other, the [[Debye model of Vibrational Heat Capacity]] deals with the [[Lattice Vibrations]] of the crystal which we discussed in [[101. Lec 37, Introduction to crystal dynamics|Lec 37]] & [[102. Lec 38, Vibrations of a monatomic chain|Lec 38]].
