...
function ItemContent({ item, isSettingsVisible, onChange, onKeyDown, }) {
    ...
    if (isSettingsVisible) {
        return (react.createElement("div", { "data-replicated-value": item.title, className: c$2("grow-wrap") },
            react.createElement("textarea", { rows: 1, ref: inputRef, className: c$2("item-input"), value: item.title, onChange: onChange, onKeyDown: onKeyDown })));
    }
    return react.createElement("div", { className: c$2("item-title") }, item.title);
}
function draggableItemFactory({ items, laneIndex, updateItem, deleteItem, archiveItem, shouldShowArchiveButton, }) {
    return (provided, snapshot, rubric) => {
        ...
        return (react.createElement("div", Object.assign({ className: `${c$2("item")} ${snapshot.isDragging ? "is-dragging" : ""}`, ref: provided.innerRef }, provided.draggableProps, provided.dragHandleProps),
            react.createElement("div", { className: c$2("item-content-wrapper") },
                react.createElement(ItemContent, { isSettingsVisible: isSettingsVisible, item: item, onChange: (e) => updateItem(laneIndex, itemIndex, update$1(item, { title: { $set: e.target.value } })), onKeyDown: (e) => {
            ...
            isSettingsVisible && (react.createElement("div", { className: c$2("item-settings") },
                react.createElement("div", { className: c$2("item-settings-actions") },
                    react.createElement("button", { onClick: () => deleteItem(laneIndex, itemIndex), className: c$2("item-button-delete") },
                        react.createElement(Icon, { name: "trash" }),
                        " Delete"),
                    react.createElement("button", { onClick: () => archiveItem(laneIndex, itemIndex, item), className: c$2("item-button-archive") },
                        react.createElement(Icon, { name: "sheets-in-box" }),
                        " Archive"))))));
    };
}
        ...
        return (react.createElement(react.Fragment, null,
            react.createElement("div", { className: c$2("item-input-wrapper") },
                react.createElement("div", { "data-replicated-value": itemTitle, className: c$2("grow-wrap") },
                    react.createElement("textarea", { rows: 1, value: itemTitle, ref: inputRef, className: c$2("item-input"), placeholder: "Item title...", onChange: (e) => setItemTitle(e.target.value), onKeyDown: (e) => {
                            if (e.key === "Enter") {
                                e.preventDefault();
                                createItem();
                            }
...
function LaneTitle({ isSettingsVisible, title, onChange, onKeyDown, }) {
    return (react.createElement("div", { className: c$2("lane-title") }, isSettingsVisible ? (react.createElement("div", { className: c$2("lane-title") },
        react.createElement("div", { "data-replicated-value": title, className: c$2("grow-wrap") },
            react.createElement("textarea", { rows: 1, value: title, className: c$2("lane-input"), placeholder: "Enter list title...", onChange: onChange, onKeyDown: onKeyDown })))) : (title)));
}
function LaneSettings({ lane, laneIndex, updateLane, deleteLane, archiveLane, }) {
    const [confirmAction, setConfirmAction] = react.useState(null);
    const actionButtons = confirmAction ? (react.createElement("div", { className: c$2("action-confirm-wrapper") },
        react.createElement("div", { className: c$2("action-confirm-text") },
            "Are you sure you want to ",
            confirmAction,
            " this list and all its cards?"),
        react.createElement("div", null,
            react.createElement("button", { onClick: () => {
                ...
                }, className: c$2("confirm-action-button") },
                "Yes, ",
                confirmAction,
                " list"),
            react.createElement("button", { onClick: () => setConfirmAction(null), className: c$2("cancel-action-button") }, "Cancel")))) : (react.createElement(react.Fragment, null,
        react.createElement("button", { onClick: () => {
            ...
            }, className: c$2("delete-lane-button") },
            react.createElement(Icon, { name: "trash" }),
            " Delete List"),
        react.createElement("button", { onClick: () => {
                if (lane.items.length == 0) {
            ...
            }, className: c$2("archive-lane-button") },
            react.createElement(Icon, { name: "sheets-in-box" }),
            " Archive List")));
    return (react.createElement("div", { className: c$2("lane-setting-wrapper") },
        react.createElement("div", { className: c$2("checkbox-wrapper") },
            ...
            react.createElement("div", { onClick: () => updateLane(laneIndex, update$1(lane, {
                    data: { $toggle: ["shouldMarkItemsComplete"] },
                })), className: `checkbox-container ${lane.data.shouldMarkItemsComplete ? "is-enabled" : ""}` })),
        react.createElement("div", { className: c$2("lane-action-wrapper") }, actionButtons)));
}
function LaneHeader({ lane, laneIndex, dragHandleProps, updateLane, deleteLane, archiveLane, }) {
    const [isSettingsVisible, setIsSettingsVisible] = react.useState(false);
    return (react.createElement(react.Fragment, null,
        react.createElement("div", { className: c$2("lane-header-wrapper") },
            ...
            react.createElement(LaneTitle, { isSettingsVisible: isSettingsVisible, title: lane.title, onChange: (e) => updateLane(laneIndex, update$1(lane, { title: { $set: e.target.value } })), onKeyDown: (e) => {
                    if (e.key === "Escape" || e.key === "Enter") {
                        e.preventDefault();
                        setIsSettingsVisible(false);
                    }
            ...
            react.createElement("div", { className: c$2("lane-settings-button-wrapper") },
                react.createElement("button", { onClick: () => {
                        setIsSettingsVisible(!isSettingsVisible);
                    }, "aria-label": isSettingsVisible ? "Close settings" : "List settings", className: `${c$2("lane-settings-button")} ${isSettingsVisible ? "is-enabled" : ""}` },
                    react.createElement(Icon, { name: isSettingsVisible ? "cross" : "gear" })))),
        isSettingsVisible && (react.createElement(LaneSettings, { lane: lane, laneIndex: laneIndex, updateLane: updateLane, deleteLane: deleteLane, archiveLane: archiveLane }))));
}

function draggableLaneFactory({ lanes, isGhost, addItemToLane, updateLane, deleteLane, archiveLane, updateItem, deleteItem, archiveItem, }) {
    return (provided, snapshot, rubric) => {
        ...
        const content = isGhost ? (react.createElement("div", { className: c$2("lane-items") }, lane.items.map((item, i) => {
        ...
        }))) : (react.createElement(ConnectedDroppable, { droppableId: lane.id, type: "ITEM", renderClone: renderItem }, (provided, snapshot) => (react.createElement("div", Object.assign({ className: `${c$2("lane-items")} ${snapshot.isDraggingOver ? "is-dragging-over" : ""}`, ref: provided.innerRef }, provided.droppableProps),
        ...
        return (react.createElement("div", Object.assign({ className: `${c$2("lane")} ${snapshot.isDragging ? "is-dragging" : ""}`, ref: provided.innerRef }, provided.draggableProps),
            react.createElement(LaneHeader, { dragHandleProps: provided.dragHandleProps, laneIndex: rubric.source.index, lane: lane, updateLane: updateLane, deleteLane: deleteLane, archiveLane: archiveLane }),
            content,
            react.createElement(ItemForm, { addItem: (item) => {
                    addItemToLane(rubric.source.index, update$1(item, {
                        data: {
                            isComplete: {
        ...
        return (react.createElement("div", { className: c$2("lane") },
            react.createElement("div", { className: c$2("lane-input-wrapper") },
                react.createElement("div", { "data-replicated-value": laneTitle, className: c$2("grow-wrap") },
                    react.createElement("textarea", { rows: 1, value: laneTitle, ref: inputRef, className: c$2("lane-input"), placeholder: "Enter list title...", onChange: (e) => setLaneTitle(e.target.value), onKeyDown: (e) => {
                            if (e.key === "Enter") {
                                e.preventDefault();
                                createLane();
                            }
...
function createBoardDragHandler({ boardData, setBoardData, }) {
    return (dropResult) => {
...
const Kanban = (props) => {
    ...
    if (boardData === null)
        return null;
    const addItemToLane = (laneIndex, item) => {
        setBoardData(update$1(boardData, {
            lanes: {
                [laneIndex]: {
                    items: {
                        $push: [item],
    ...
    const updateLane = (laneIndex, lane) => {
        setBoardData(update$1(boardData, {
            lanes: {
                [laneIndex]: {
                    $set: lane,
    ...
    const deleteItem = (laneIndex, itemIndex) => {
        setBoardData(update$1(boardData, {
            lanes: {
                [laneIndex]: {
                    items: {
    ...
    const updateItem = (laneIndex, itemIndex, item) => {
        setBoardData(update$1(boardData, {
            lanes: {
                [laneIndex]: {
                    items: {
    ...
    const archiveItem = (laneIndex, itemIndex, item) => {
        setBoardData(update$1(boardData, {
            lanes: {
                [laneIndex]: {
                    items: {
    ...
    const renderLaneGhost = draggableLaneFactory(Object.assign(Object.assign({}, laneFactoryParams), { isGhost: true }));
    const renderLanes = (provided) => (react.createElement("div", Object.assign({ className: c$2("board"), ref: provided.innerRef }, provided.droppableProps),
        ...
        provided.placeholder,
        react.createElement(LaneForm, { addLane: addLane })));
...
class KanbanView extends obsidian.TextFileView {
    ...
    constructKanban() {
        reactDom.unmountComponentAtNode(this.contentEl);
        reactDom.render(react.createElement(Kanban, { dataBridge: this.dataBridge }), this.contentEl);
    }
}
